...
final class LoggerPrinter implements Printer {
  ...
  @Override
  public void d2(String tag, String message) {
    log2(DEBUG, null, tag, message);
  }
...
//  }
  ...
  @Override
  public void e2(String tag, String message) {
    log2(ERROR, null, tag, message);
  }
  ...
  @Override
  public void w2(String tag, String message) {
    log2(WARN, null, tag, message);
  }
  ...
  @Override
  public void i2(String tag, String message) {
    log2(INFO, null, tag, message);
  }
  ...
  @Override
  public void v2(String tag, String message) {
    log2(VERBOSE, null, tag, message);
  }
  ...
  @Override
  public void wtf2(String tag, String message) {
    log2(ASSERT, null, tag, message);
  }
  ...
  @Override
  public void json2(String tag, String json) {
    if (Helper.isEmpty(json)) {
      d2(tag, "Empty/Null json content");
      return;
    }
  ...
  @Override
  public void xml2(String tag, String xml) {
    if (Helper.isEmpty(xml)) {
      d2(tag, "Empty/Null xml content");
      return;
    }
    try {
      Source xmlInput = new StreamSource(new StringReader(xml));
      ...
      transformer.setOutputProperty("{http://xml.apache.org/xslt}indent-amount", "2");
      transformer.transform(xmlInput, xmlOutput);
      d2(tag, xmlOutput.getWriter().toString().replaceFirst(">", ">\n"));
    } catch (TransformerException e) {
      e2(tag, "Invalid xml");
    }
  }
  ...
  private synchronized void log2(int priority, Throwable throwable, String tag, String msg, Object... args) {
    if (settings.getLogLevel() == LogLevel.NONE) {
      return;
    }
    String message = createMessage(msg, args);
